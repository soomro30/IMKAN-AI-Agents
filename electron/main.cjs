...
function ensureEnvFile() {
  ...
  if (!fs.existsSync(envPath)) {
    ...
    // For development, update these values in your local build
    const envContent = `# IMKAN Agents - Auto-generated Configuration
# Do not edit this file manually - use the app settings instead

BROWSERBASE_API_KEY=${process.env.BROWSERBASE_API_KEY || 'your_browserbase_api_key_here'}
BROWSERBASE_PROJECT_ID=${process.env.BROWSERBASE_PROJECT_ID || 'your_project_id_here'}
OPENAI_API_KEY=${process.env.OPENAI_API_KEY || 'your_openai_api_key_here'}
TAMM_MOBILE_NUMBER=${process.env.TAMM_MOBILE_NUMBER || '971559419961'}
`;
